...
Ignacio solo sabe bordar cuadraditos de colores, y los unirá formando una cadena de cuadraditos, uno a continuación del otro, para formar su guarda de N cuadraditos en total. Cada cuadradito será de algún color.
Hay 26 colores posibles, y cada color se identifica usando una de las 26 letras minúsculas del alfabeto inglés. Por ejemplo a se usa para el azul, b para el bermellón, c para el carmín, y así siguiendo. Lo único importante para resolver el problema es que hay 26 colores, y cada letra representa un color distinto.
...
Objetivo
Debes implementar la función formaguarda(N, tipo, patron) Sus parámetros son:
